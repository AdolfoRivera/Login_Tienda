...
namespace Login_Tienda
{
     ...
     */
        ...
        private void datos_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            /* ventas v = new ventas();
             v.txtcodigo.text=dataGritView1.CurrentRow.Cells[0].values.toString();
             v.txtproducto.text=dataGritView1.CurrentRow.Cells[1].values.toString();
             v.txtprecio.text=dataGritView1.CurrentRow.Cells[2].values.toString();
             v.Show();*/
        ...
        {
            datos.RowsDefaultCellStyle.BackColor = Color.AliceBlue;
